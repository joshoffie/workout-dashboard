...
function runComparisonLogic() {
  ...
  // 9. Log everything to the console (good for debugging)
  console.log("--- WORKOUT COMPARISON (STEP 3) ---");
  console.log(`[runComparisonLogic] Current (${mostRecentDate.toDateString()}):`, currentStats);
  console.log(`[runComparisonLogic] Previous (${previousWorkoutDate.toDateString()}):`, prevStats);
  console.log("-------------------------------------");
